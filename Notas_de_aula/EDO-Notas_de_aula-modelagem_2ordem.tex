...
equação fica apenas $s''+\omega^2s=0$. Essa mudança de variáveis tem
algumas vantagens: (a) A equação fica com uma única constante e (b)
esta constante tem uma interpretação física: a frequência (angular) da
oscilação e (c) $\omega$ já aparece na solução da EDO!
...
\begin{itemize}
\item Frequência $\omega = \frac{k}{m}$
