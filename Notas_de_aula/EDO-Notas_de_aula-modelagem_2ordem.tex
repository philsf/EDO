...
Sabendo este valor de $\omega$, a solução geral desta equação é $s(t) = K_1 \cos (2 t) + K_2 \sin (2 t)$.
O período da oscilação é $T=\frac{2\pi}{2}=\pi$.
...
nas exponenciais! Esta é a ideia que unifica todas as fórmulas abaixo:
