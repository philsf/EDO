...
Simplificando, isto é, digidindo por $m$, temos:

\begin{displaymath}
  v' = g - \frac{\alpha}{m} v
\end{displaymath}

Podemos colocar o coeficiente de $v$ no lado direito da igualdade
dividindo ambos os termos por ele, encontrando:
...
Agora, com o coeficiente de $v$ do lado direito em evidência, fica
fácil para separar as variáveis e resolver a equação.

{\bf Exemplo:}

Josefina salta de um avião e abre o pára-quedas imediatamente. Sua
velocidade inicial é $v_0=0$. Jô pesa $50kg$ e digamos que o
coeficiente de arrasto do ar nesse local é $\alpha = 25$. Assumindo
que a gravidade é $g=10\frac{m}{s^2}$, qual será a velocidade de Jô
após $t=10s$ de pura adrenalina?
...
\begin{displaymath}
  v' =  -\frac{25}{50} ( v - \frac{50 \times 10}{25}) = -\frac{1}{10}(v - 20)
\end{displaymath}
...
A família de soluções da EDO é $v(t)=K e^{-1/10t}+20$. Substituindo a
...
tempo. Como queremos saber a velocidade depois de $10s$, basta
substituir $t=10$ e encontrar:
...
encontrar um valor numérico aproximado de $13\frac{m}{s}$ ou ainda
$47\frac{km}{h}$. É uma velocidade considerável para apenas $10s$ de
queda!

\hrulefill

{\bf Desafio 1:} Qual seria a velocidade de Jô depois de $10s$ se ela
