...
coeficiente de arrasto do ar nesse local é $\alpha = 5$. Assumindo
...
\begin{displaymath}
  v' =  -\frac{5}{50} ( v - \frac{50 \times 10}{5}) = -\frac{1}{10}(v - 100)
\end{displaymath}
...
A família de soluções da EDO é $v(t)=K e^{-1/10t}+100$. Substituindo a
...
encontrar um valor numérico aproximado de $63\frac{m}{s}$ . É uma
velocidade considerável para apenas $10s$ de queda! Jô deveria ter
usado um pára-quedas maior \ldots
