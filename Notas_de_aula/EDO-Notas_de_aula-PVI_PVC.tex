...
Inicial (PVI) e como visualizá-lo graficamente no Campo de Direções da
equação.
...
O aluno deve consultar o livro texto nas seções 11.1 (PVI) e 11.2 (CD)
para se aprofundar no conteúdo desta aula.

\subsection{Problema}

Como visualizar graficamente uma solução de uma EDO? E a família de soluções?
